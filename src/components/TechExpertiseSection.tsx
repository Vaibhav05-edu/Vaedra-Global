...
const TechExpertiseSection = () => {
  return (
    <section className="bg-[hsl(0,0%,10%)] py-20 lg:py-28">
      <div className="container mx-auto px-6 lg:px-12 xl:px-16">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12">
          {technologies.map((tech, i) => (
            ...
            >
              <div className="relative w-36 h-36 md:w-44 md:h-44 rounded-full border border-foreground/20 flex items-center justify-center">
                <tech.icon className="w-16 h-16 md:w-20 md:h-20 text-foreground" strokeWidth={1.2} />
              </div>
              <span className="font-display text-sm md:text-base font-bold uppercase tracking-wider text-foreground">
                {tech.name}
              </span>
            </motion.div>
          ))}
